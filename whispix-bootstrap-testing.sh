...
if [ ! -d ~/.cache/drag/stash/eudev ]; then
...
EOF
touch ~/.cache/drag/stash/eudev/sup-nerds
fi

[ -f ~/.cache/drag/stash/eudev/sup-nerds ] && snoop eudev && rm ~/.cache/drag/stash/eudev/sup-nerds
[ ! -d ~/.cache/drag/stash/${cigs[-1]}   ] && stash ${cigs[@]}
smoke ${cigs[@]}
smoke eudev
